...
export default function LiquidEther({
  ...
  resolution = 0.5,
  isBounce = false,
  colors = ['#a855f7', '#ec4899', '#facc15', '#22d3ee', '#a855f7'],
  style = {},
  className = '',
  autoDemo = true,
  autoSpeed = 0.5,
  ...
  useEffect(() => {
    ...
    class Advection extends ShaderPass {
      ...
      update(props?: { dt?: number; isBounce?: boolean; BFECC?: boolean }) {
        if (props) {
          if (props.dt !== undefined) this.uniforms.dt.value = props.dt;
          if (this.line && props.isBounce !== undefined) this.line.visible = props.isBounce;
          if (props.BFECC !== undefined) this.uniforms.isBFECC.value = props.BFECC;
        }
        super.update();
      }
    }
    ...
    class Viscous extends ShaderPass {
      ...
      update(props?: { viscous?: number; iterations?: number; dt?: number }) {
        if (!props) return;
        let fbo_in, fbo_out;
        if (props.viscous !== undefined) this.uniforms.v.value = props.viscous;
        const iterations = props.iterations || 32;
    ...
    class Pressure extends ShaderPass {
      ...
      update(props?: { vel?: any; pressure?: any }) {
